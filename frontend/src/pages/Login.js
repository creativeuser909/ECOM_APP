			...
			try {
				...
				if (response.ok) {
					...
					localStorage.setItem(
						"profilePic",
						json.userData.profilePic
					);
					localStorage.setItem("firstname", json.userData.firstname);
					localStorage.setItem("email", json.userData.email);
					localStorage.setItem("role", json.userData.role);
					if (json) {
						setUserData({
							...userData,
							firstname: json.userData.firstname,
							token: json.token,
							profilePic: json.userData.profilePic,
							email: json.userData.email,
							role: json.userData.role
						});
					}
					navigateTo("/");
				} else {
